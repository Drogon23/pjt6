		...
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
				  ...
				  <a href="#" class="btn_my"> <span title="예약확인">${rsvEmail}</span> </a>
			</header>
		</div>
		<div class="ct">
			<div class="ct_wrap">
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/png, image/jpg" multiple>
						<div class="guide_review">
							<span id="count_text">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
						...
						<div class="item_preview_thumbs">
							<ul class="lst_thumb">
								<li class="item" style="display: none;">
									<a class="anchor" id="delete_img">
										<span class="spr_book ico_del">삭제</span>
									</a>
									<img src="http://naverbooking.phinf.naver.net/20170306_3/1488772023601A4195_JPEG/image.jpg?type=f300_300" style="width:130px" alt="썸네일" class="item_thumb">
