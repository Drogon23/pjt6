	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<a href="#" class="btn_my"> <span title="내예약" class="viewReservation">${rsvEmail}</span> </a>
			</header>
		</div>
		<hr>
		<div class="ct">
			<div class="section_my">
				...
				<div class="my_summary">
					<ul class="summary_board">
						...
						<li class="item">
							<a class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span class="figure" id="before_count">${fn:length(notUsedRsvList)}</span> </a>
						</li>
						<li class="item">
							<a class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span class="figure">${fn:length(usedRsvList)}</span> </a>
						</li>
						<li class="item">
							<a class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span class="figure" id="canceled_count">${fn:length(canceledRsvList)}</span> </a>
						</li>
					</ul>
				</div>
				<!--// 예약 현황 -->
					...
					<ul class="list_cards" ng-if="bookedLists.length > 0">
						...
						<li class="card confirmed">
							<div class="link_booking_details">
								...
								<c:forEach var="rsv" items="${notUsedRsvList}" >
										...
										<div class="card_body">
											...
											<div class="middle">
												<div class="card_detail">
													<em class="booking_number" data-id="${rsv.id}">No.<fmt:formatNumber value="${rsv.id}" pattern="0000000" /></em>
													<h4 class="tit" data-dp="${rsv.displayInfoId}">${rsv.productDescription}</h4>
													<ul class="detail">
														<li class="item">
															<span class="item_tit">일정</span>
															<em class="item_dsc">
																<fmt:formatDate pattern = "yyyy-MM-dd.(E)" value = "${rsv.reservationDate}" />
															</em>
														</li>
														<li class="item">
													...
													<div class="price_summary">
														...
														<em class="price_amount">
															<span><fmt:formatNumber value="${rsv.sumPrice}" pattern="#,###" /></span>
							...
							<li class="card used">
								...
								<c:forEach var="rsv" items="${usedRsvList}" >
								<article class="card_item">
									<a class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
							...
							<li class="card used cancel">
								...
								<c:forEach var="rsv" items="${canceledRsvList}" >
								<article class="card_item">
									<a class="link_booking_details">
										<div class="card_body">
											<div class="left"></div>
